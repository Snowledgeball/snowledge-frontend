...
export default function CommunityCard({
  ...
  return (
    <Card
      ...
      aria-label={t("communities.card_aria_label", { name })}
    >
      ...
      <div className="relative h-48 w-full">
        <Image
          ...
          alt={t("communities.image_alt", { name })}
          quality={75}
          loading="eager"
      ...
      <CardContent className="p-6 relative">
        ...
        <div className="flex items-center mb-4 pb-4 border-b border-gray-100">
          <Image
            src={creator.avatar}
            alt={t("communities.creator_avatar_alt", { name: creator.name })}
            width={32}
            height={32}
        ...
        <div className="space-y-3">
          <div className="flex items-center text-gray-600">
            <Users className="w-5 h-5 text-blue-500 mr-3" aria-hidden="true" />
