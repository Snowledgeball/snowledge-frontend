        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600">Utilisez l'intelligence artificielle pour améliorer vos textes</p>
                </div>
                        ...
                        <div className="space-y-3">
                            {aiAssistantData.suggestions.map((suggestion, index) => (
                                <div key={index} className="p-3 bg-purple-50 rounded-lg border border-purple-100">
                                    ...
                                    <button className="text-xs text-purple-600 mt-1 hover:underline">{suggestion.action}</button>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center">
                                ...
                                <span className="ml-2 text-sm font-medium text-gray-700">{aiAssistantData.seoScore}%</span>
                            </div>
                            <p className="text-xs text-gray-500">Densité des mots-clés optimale</p>
