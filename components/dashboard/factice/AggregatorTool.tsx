    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Agrégateur de Sources</h2>
                    <p className="text-gray-600 dark:text-gray-400">Centralisation et gestion des flux d'information</p>
                </div>
            ...
            <div className="mb-6">
                <div className="flex justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Sources configurées</h3>
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Dernières mises à jour</h3>
            ...
            <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Statistiques</h3>
                <div className="grid grid-cols-3 gap-4">
                    <StatCard title="Sources actives" value="24" change="+3" />
                    <StatCard title="Articles aujourd'hui" value="146" change="+52" />
                    <StatCard title="Taux d'engagement" value="18.7%" change="-2.3%" isNegative />
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
                <div className={`w-3 h-3 rounded-full ${source.active ? 'bg-green-500' : 'bg-gray-400'}`}></div>
                <span className="font-medium text-gray-800 dark:text-gray-200">{source.name}</span>
    ...
    return (
        <div className="border-l-4 border-indigo-500 pl-4 py-2">
            <div className="flex justify-between">
                <h4 className="font-medium text-gray-800 dark:text-gray-200">{update.title}</h4>
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <div className="flex items-end justify-between mt-2">
                <span className="text-2xl font-bold text-gray-800 dark:text-gray-200">{value}</span>
...
const updates = [
    {
        ...
        content: 'Le fondateur d Ethereum a annoncé une mise à jour importante concernant la transition vers PoS.',
        source: 'Twitter',
        time: 'Il y a 23 min'
    },
    {
        ...
        content: 'Le BTC a franchi la barre des 42 000$ suite à des annonces positives de la SEC.',
        source: 'Coindesk',
        time: 'Il y a 1h'
    },
    {
        ...
        content: "Un nouveau protocole DeFi attire l'attention avec plus de 500M$ de TVL en 48h.",
        source: 'Reddit',
        time: 'Il y a 3h'
    }
]; 