...
// ------------
// DESCRIPTION: Card de configuration d'analyse de sentiment multi-plateformes, réutilisable, avec tous les champs et contrôles nécessaires. Section description spécifique à l'analyse de sentiment.
...
export function SentimentInput({
  ...
  return (
    <div className="bg-muted rounded-xl shadow p-6 flex flex-col gap-10">
      ...
      <AnalysisDescription type="sentiment" />
      {/* 6. Launch button */}
      <div className="pt-2">
        <Button
