...
export class DiscordService {
        ...
        async createDiscordAccess(createDiscordAccessDto: CreateDiscordAccessDto): Promise<DiscordAccess> {
            const character = await this.discardAccessRepository.create(createDiscordAccessDto);
